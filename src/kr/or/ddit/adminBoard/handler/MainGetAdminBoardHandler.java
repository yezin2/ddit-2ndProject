...
public class MainGetAdminBoardHandler implements CommandHandler{
	...
	public String process(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		if("not".equals(finalURI)) {
			VIEW_PAGE = "/WEB-INF/view/adminBoardMain/noticeGet.jsp";
			code = "NOTICE";
		}else if("faq".equals(finalURI)){
			VIEW_PAGE = "/WEB-INF/view/adminBoardMain/faqGet.jsp";
			code = "FAQ";
		}
